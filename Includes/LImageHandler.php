...
class LImageHandler
{
     ...
     * @param integer $angle
     * @param integer $alpha - text opacity
     * @param integer $bgalpha - background opacity
     * @param integer $bgpadding - background padding
     * @return \LImageHandler
     * @throws Exception
     */
    public function textWithBackground($text, 
            $fontFile, 
            $size = 12, 
            $color = array(0, 0, 0), 
            $bgcolor = array(0, 0, 0), 
            ...
            $bgpadding = 10)
    {
        ...
        $bgcolor = imagecolorallocatealpha($this->image, $bgcolor[0], $bgcolor[1], $bgcolor[2], $bgalpha);

        // lower left, lower right, upper right, upper left
        $cornersOutput = imagettftext($this->image, $size, 0, $posX, $posY + $textHeight, $color, $fontFile, $text);
       
        $cornersOutput[0] = $cornersOutput[0] - $bgpadding;
        $cornersOutput[1] = $cornersOutput[1] + $bgpadding;
        $cornersOutput[2] = $cornersOutput[2] + $bgpadding;
        $cornersOutput[3] = $cornersOutput[3] + $bgpadding;
        $cornersOutput[4] = $cornersOutput[4] + $bgpadding;
        $cornersOutput[5] = $cornersOutput[5] - $bgpadding;
        $cornersOutput[6] = $cornersOutput[6] - $bgpadding;
        $cornersOutput[7] = $cornersOutput[7] - $bgpadding;
             
        imagefilledpolygon($this->image, $cornersOutput, 4, $bgcolor);
        
        imagettftext($this->image, $size, 0, $posX, $posY + $textHeight, $color, $fontFile, $text);
